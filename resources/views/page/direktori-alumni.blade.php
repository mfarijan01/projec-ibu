...
<header class="pt-3 border-bottom">
    <div class="container pt-md-1 pb-md-1">
        <h3 class="bd-title mt-3 mb-4 font-weight-bold" style="color: #058532;"><i class="fas fa-newspaper" aria-hidden="true"></i> Direktori alumni</h3>
    </div>
</header>
...
<table class="table table-bordered" id="format">
                    ...
                    <th  style="background:#058532;color:#fff;" scope="col">NAMA&nbsp;</th>
                                ...
                                <th  style="background:#058532;color:#fff;" scope="col">KEGIATAN&nbsp;</th>
                                <th  style="background:#058532;color:#fff;" scope="col">TEMPAT KEGIATAN&nbsp;</th>
                                <th  style="background:#058532;color:#fff;" scope="col">ALAMAT TEMPAT KEGIATAN&nbsp;</th>
                                <th  style="background:#058532;color:#fff;" scope="col">TAHUN LULUS&nbsp;</th>
